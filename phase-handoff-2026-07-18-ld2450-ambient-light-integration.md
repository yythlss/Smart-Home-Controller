...
main/boards/bread-compact-wifi/ld2450_and_light_wiring_verification.md
...
1. 按 [硬件连接和验证手册](../main/boards/bread-compact-wifi/ld2450_and_light_wiring_verification.md) 完成接线。
